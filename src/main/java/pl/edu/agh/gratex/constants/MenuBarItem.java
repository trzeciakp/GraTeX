...
public enum MenuBarItem {
    ...
    COPY("Copy selected subgraph", 'C', KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK), MenuBarSubmenu.EDIT, false, false),
    PASTE("Paste copied subgraph", 'P', KeyStroke.getKeyStroke(KeyEvent.VK_V, ActionEvent.CTRL_MASK), MenuBarSubmenu.EDIT, false, false),
