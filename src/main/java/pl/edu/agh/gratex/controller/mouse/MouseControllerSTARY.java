...
public class MouseControllerSTARY implements MouseController, ModeListener, ToolListener, Serializable {
    ...
    public MouseControllerSTARY(GeneralController generalController, OperationController operationController, ModeController modeController, ToolController toolController) {
